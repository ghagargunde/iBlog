    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-danger text-white mb-4">
                ...
                <?php
                        $dash_block_user_query = "SELECT * FROM users WHERE status='1' ";
                        $dash_block_user_query_run = mysqli_query($con,$dash_block_user_query);
                        if($block_user_total = mysqli_num_rows($dash_block_user_query_run))
                        {
                            echo '<h4 class="mb-0">'.$block_user_total.'</h4>';
                        }
                        else
                        {
