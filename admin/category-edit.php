                     ...
                     <form action="code.php" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea name="description" required class="form-control" row="4"><?= $row['description'] ?> </textarea>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="checkbox" name="navbar_status" row="4" <?= $row['navbar_status'] == '1' ? 'checked':'' ?> width="70px" height="70px" />
                                    </div>
                                    <div class="col-md-6 mb-3">
