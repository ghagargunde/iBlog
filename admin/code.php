...
if(isset($_POST['post_delete_btn']))
{
    ...
    if($query_run)
    {
       if(file_exists("../uploads/posts/".$image)){
        ...
        $_SESSION['message']="Post Deleted Successtully";
...
if(isset($_POST['post_update']))
{
    ...
    $query="UPDATE posts SET category_id='$category_id',name='$name',
    slug='$slug', description='$description',image='$update_filename',
